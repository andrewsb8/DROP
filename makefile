...
compile:
	...
	gcc -o drop drop.o commands.o readProtein.o setDihedral.o measureDihedrals.o dihedralRotation.o vectorCalculus.o fileHandling.o stericClashes.o stericClash.o -lm
	rm *.o
