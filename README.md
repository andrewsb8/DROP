...
This is not a pdb (or any structure file) preprocessing tool. It requires a sanitized pdb file and some modules require CONECT records for covalent bonds. I personally use [GROMACS](https://www.gromacs.org/) ([gitlab](https://gitlab.com/gromacs/gromacs)) to produce ordered pdb files and CONECT records. See ```scripts/generate-conect/``` for more details.
