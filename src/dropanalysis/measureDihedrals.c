...
void measureDihedrals(int argc, char **argv, char *stringArgv)
{
  struct argp_option measureDihedralsOptions[] =
  {
    ...
    { "dihedral_list", 'd', "[Output File]", 0, "Optional output file name to print the dihedral information to a file that can be modified and used as an input file for setDihedralList."},
