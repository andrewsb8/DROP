...
double
vectorMagnitude (double vector1[3])
{
  double result = 0;
  for (int i = 0; i < 3; i++)
	{
...
double
dotProduct (double vector1[3], double vector2[3])
{
  double result = 0;
  for (int i = 0; i < 3; i++)
	{
...
double *
vectorAdd (double vector1[3], double vector2[3])
{
...
double *
vectorSubtract (double vector1[3], double vector2[3])
{
  double *result = malloc (sizeof (double) * 3);
  for (int i = 0; i < 3; i++)
	{
...
double *
crossProduct (double vector1[3], double vector2[3])
{
...
double *
matrixVectorMult (double matrix[3][3], double vector[3])
{
  double *result = malloc (sizeof (double) * 3);
...
double *
vectorRotate (double vector1[3], int axisOfRotation, double angle)
{
  double mat[3][3][3] = {
...
double *
cartesianToPolar (double vector[3])
{
  double *result = malloc (sizeof (double) * 3);
...
double *
polarToCartesian (double vector[3])
{
  double *result = malloc (sizeof (double) * 3);
